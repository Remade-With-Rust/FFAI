...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    for &n in &[1usize, 10, 25, 50, 100, 200] {
        ...
        println!("  cache len {n:4}: cat = {:7.2} us   ({:.1} KB copied)", b*1e6, (n+1)*d*4/1024);
    }
    ...
    for &n in &[50usize, 224] {
        ...
        println!("  growing to {n:4} tokens by cat: {:8.2} us total  (x2 for K and V = {:.2} us)", total*1e6, total*2e6);
    }
    Ok(())
}
